...
While much of your programming experience will be relevant to Ethereum programming, there are some pitfalls to be aware of.
  ...
  - Sense of time on blockchain is different, to some extent miner can control the time of execution of a transaction.
  - Randomness is non-trivial on blockchain, because many approaches of random number generation worked on traditional programs can be easily exploited on blockchain.
